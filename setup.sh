...
HEROKU_TEAM_NAME="sfdc-cc-it"

# Descriptive name for the Heroku app
HEROKU_APP_NAME="PipelineTest"
...
DEV_HUB_USERNAME="cmsartdevhub"
DEV_USERNAME="PipelineTestOrg"
STAGING_USERNAME="PipelineTestOrg"
PROD_USERNAME="PipelineTestOrg"
